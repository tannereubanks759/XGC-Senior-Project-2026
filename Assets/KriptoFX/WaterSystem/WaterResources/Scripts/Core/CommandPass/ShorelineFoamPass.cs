...
namespace KWS
{
    internal class ShorelineFoamPass : WaterPass
    {
        ...
        public override void ExecuteCommandBuffer(WaterPass.WaterPassContext waterContext)
        {
            ...
            cmd.SetComputeTextureParam(foamComputeShader, _clearKernel,        "_BlueNoise", KWS_CoreUtils.DefaultGrayTexture);
            cmd.SetComputeTextureParam(foamComputeShader, _drawToBufferKernel, "_BlueNoise", KWS_CoreUtils.DefaultGrayTexture);
            cmd.SetComputeTextureParam(foamComputeShader, _drawToTextureKernel, "_BlueNoise", KWS_CoreUtils.DefaultGrayTexture);
            ...
            cmd.SetComputeTextureParam(foamComputeShader, _drawToBufferKernel, "_AtmosphericScatteringLUT", CoreUtils.blackVolumeTexture);
            ...
            _computeBufferLodIndexes = KWS_CoreUtils.GetOrUpdateBuffer<int>(ref _computeBufferLodIndexes, allIndexes.Count);
             cmd.SetBufferData(_computeBufferLodIndexes, allIndexes);
