...
namespace KWS
{
    internal class FftWavesPass : WaterPass
    {
        ...
        public override void ExecutePerFrame(HashSet<Camera> cameras, CustomFixedUpdates fixedUpdates)
        {
           ...
           if (WaterSharedResources.IsAnyWaterUseGlobalWind && (WaterSystem.UseNetworkBuoyancy || WaterSharedResources.IsAnyWaterVisible()))
            {
        ...
        {
            if (data.DisplaceTexture[0] == null) {
InitializeFftWavesData(settings, data);
