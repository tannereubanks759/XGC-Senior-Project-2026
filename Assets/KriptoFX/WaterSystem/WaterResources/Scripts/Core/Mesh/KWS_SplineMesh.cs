...
namespace KWS
{
    ...
    internal class KWS_SplineMesh
    {
        ...
        public bool IsIntersectRiver(WaterSystem waterInstance, Vector3 worldPos, float threshold)
        {
            ...
            var closest = meshCollider.ClosestPoint(worldPos);
            return Vector3.Distance(closest, worldPos) < threshold;
        }
