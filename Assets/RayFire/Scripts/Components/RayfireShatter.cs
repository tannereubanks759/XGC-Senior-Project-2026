...
namespace RayFire
{
    ...
    public class RayfireShatter : MonoBehaviour
    {
        ...
        // UI
        public RFEngineType      engineType = RFEngineType.V1;
        ...
        {
            // TODO TEMP 
            if (engineType == RFEngineType.V2 && type == FragType.Tets)
            {
            ...
            // Engine
            if (engineType == RFEngineType.V1)
                FragmentV1 ();
            else if (engineType == RFEngineType.V2)
                FragmentV2();
        ...
        {
            // Engine change check
            if (intEng != engineType)
            {
                Debug.Log("Engine can not be changed in Interactive mode. Set Engine property back to " + intEng.ToString());
                return;
            }
        ...
        {
            if (engineType == RFEngineType.V1)
                InteractiveFragmentV1();
            else if (engineType == RFEngineType.V2)
                RFEngine.InteractiveFragment(this);
        }
        
        // Create interactively cached fragments
        void InteractiveFragmentV1()
        {
        ...
        public void InteractiveStop(RayfireShatter sh)
        {
            // Enable own Renderer
